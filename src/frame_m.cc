...
void Frame_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->frameNum);
    doParsimPacking(b,this->sessionNumber);
...
void Frame_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->frameNum);
    doParsimUnpacking(b,this->sessionNumber);
    doParsimUnpacking(b,this->payLoad);
}

uint8_t Frame_Base::getType() const
{
    return this->type;
}

void Frame_Base::setType(uint8_t type)
{
    this->type = type;
}

long Frame_Base::getFrameNum() const
{
    return this->frameNum;
}

void Frame_Base::setFrameNum(long frameNum)
{
    this->frameNum = frameNum;
}

long Frame_Base::getSessionNumber() const
{
    return this->sessionNumber;
}

void Frame_Base::setSessionNumber(long sessionNumber)
{
...
int FrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='f' && strcmp(fieldName, "frameNum")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "sessionNumber")==0) return base+2;
...
std::string FrameDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getFrameNum());
        case 2: return long2string(pp->getSessionNumber());
...
bool FrameDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setFrameNum(string2long(value)); return true;
        case 2: pp->setSessionNumber(string2long(value)); return true;
